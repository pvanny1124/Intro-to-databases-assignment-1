...
insert sales values ('7066', 'BA27618', '85/10/12' );
 
insert sales values ('5023', 'AB-123-DEF-425-1Z3', '85/10/31' );
 
insert sales values ('5023', 'AB-872-DEF-732-2Z1', '85/11/06' );
 
insert sales values ('8042', '12-F-9', '86/07/13' );
 
insert sales values ('7896', '124152', '86/08/14' );
 
insert sales values ('7131', 'Asoap132', '86/11/16' );
 
insert sales values ('5023', 'BS-345-DSE-860-1F2', '86/12/12' );
 
insert sales values ('7067', 'NB-1.142', '86/01/02' );
 
insert sales values ('5023', 'AX-532-FED-452-2Z7', '90/12/01' );
 
insert sales values ('5023', 'NF-123-ADS-642-9G3', '90/07/18' );
 
insert sales values ('7131', 'Fsoap867', '87/09/08' );
 
insert sales values ('7066', 'BA52498', '87/10/27' );
 
insert sales values ('8042', '91-A-7', '91/03/20' );
 
insert sales values ('8042', '91-V-7', '91/03/20' );
 
insert sales values ('8042', '55-V-7', '91/03/20' );
 
insert sales values ('8042', '13-J-9', '88/01/13' );
 
insert sales values ('7896', '234518', '91/02/14' );
 
insert sales values ('5023', 'GH-542-NAD-713-9F9', '87/03/15' );
 
insert sales values ('7131', 'Asoap432', '90/12/20' );
 
insert sales values ('5023', 'ZA-000-ASD-324-4D1', '88/07/27' );
 
insert sales values ('7066', 'BA71224', '88/08/05' );
 
insert sales values ('5023', 'ZD-123-DFG-752-9G8', '91/03/21' );
 
insert sales values ('8042', '13-E-7', '89/05/23' );
 
insert sales values ('7067', 'NB-3.142', '90/06/13' );
 
insert sales values ('5023', 'ZS-645-CAT-415-1B2', '91/03/21' );
 
insert sales values ('5023', 'XS-135-DER-432-8J2', '91/03/21' );
 
insert sales values ('5023', 'ZZ-999-ZZZ-999-0A0', '91/03/21' );
 
insert sales values ('6380', '342157', '85/12/13' );
 
insert sales values ('6380', '356921', '91/02/17' );
 
insert sales values ('6380', '234518', '87/09/30' );
...
'Helpful hints on how to use your electronic resources to the best advantage.', '88/06/09', 1 );
...
insert titles (title_id, title, type, pub_id, contract )
values('MC3026', 'The Psychology of Computer Cooking','UNDECIDED', '0877', 0 );
